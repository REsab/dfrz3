...
//在二级菜单 下
     ...
     */
//*-------------------------------------------------------------------------------------------------
    public boolean execLogin() {
        boolean isKeepLogin = true;
        aa:
        while (isKeepLogin) {
            ...
            if (manager.password.equals(pwd) && manager.userName.equals(userName)) {
                isKeepLogin = false;
                return true;

            } else {
                System.out.println("密码错误,按0退出  任意键继续");
    ...
    public void showSendMenu() {
        ...
        switchMenu(4, getAnInputInt(0, 4));
